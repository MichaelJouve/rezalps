                                                    ...
                                                    <div class="card-body">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control"
                                                                   ...
                                                                   name="name" id="name" value="{{ $authUser->name }}">
                                                        </div>
                                                        <div class="form-group">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="tel" class="form-control"
                                                                   ...
                                                                   id="phone_number" value="{{ old('phone_number', $authUser->phone_number) }}">
                                                        </div>
                                                        <div class="form-group">
                                                            ...
                                                            <input type="date" class="form-control"
                                                                   ...
                                                                   id="datepicker" value="{{ $authUser->birthdate }}">
                                                        </div>
                                                        <div class="form-group">
