                                    ...
                                    <div class="card_parametre mb-3 mt-3">
                                        <div class="row col-12 justify-centent-between">
                                            ...
                                            <div class="offset-3 col-6 offset-3">
                                                <form method="post" action="" name="photo" class="form_parametre"
                                                      id="form_photo">
                                        ...
                                        <div class="card_parametre mb-3 mt-3">
                                            <div class="row col-12 justify-centent-between">
                                                ...
                                                <div class="offset-3 col-6 offset-3">
                                                    <form method="" action="" name="" class="form_parametre"
                                                          id="form_name">
                                                        <div class="input-group">
                                                            ...
                                                            <input type="name" class="form-control"
                                                                   aria-describedby="Votre prénom" placeholder="Prénom"
                                                                   name="name2" id="name2">
                                                ...
                                                <div class="offset-3 col-6 offset-3">
                                                    <form method="" action="" name="" class="form_parametre"
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <button class="btn btn-secondary" type="submit">Soumettre
                                                            </button>
                                                        </div>
                                                    </form>
                                                </div>
                                                    ...
                                                    <form method="" action="" name="" class="form_parametre"
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" class="form-control"
                                                                   ...
                                                                   placeholder="Nouvelle adresse email" name="mail"
                                                                   id="mail">
                                                            <button class="btn btn-secondary" type="submit">Soumettre
                                                            </button>
                                                        </div>
                                                    ...
                                                    <form method="" action="" name="" class="form_parametre"
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input type="tel" class="form-control"
                                                                   ...
                                                                   placeholder="Numero de téléphone" name="tel" id="tel"
                                                ...
                                                <div class="offset-3 col-6 offset-3">
                                                    <form method="" action="" name="" class="form_parametre"
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input type="password" class="form-control"
                                                                   placeholder="Confirmation" name="mp_connexion"
                                                                   id="mdp2">
                                                            <button class="btn btn-secondary" type="submit">Soumettre
                                                            </button>
                                                        </div>
