        ...
        <div class="col-10 offset-1">
            <div>
                <p>
                    ...
                    confiance dans l’économie numérique, les responsables du présent site internet www.rezalps.fr sont :
                </p>
                <h2>
                    Editeur du Site:
                </h2>
                ...
                <p>
                    Ce site www.rezalps.fr est proposé en différents langages web (HTML, JavaScript, CSS, PHP, etc…)
                ...
                <p>
                    L’agence web SAS Epik met en œuvre tous les moyens dont elle dispose, pour assurer une information
                ...
                <p>
                    Cookies: Le site www.rezalps.fr peut-être amené à vous demander l’acceptation des cookies pour des
                    besoins de statistiques et d’affichage. Un cookies est une information déposée sur votre disque dur
                    par le serveur du site que vous visitez. Il contient plusieurs données qui sont stockées sur votre
                ...
                <p>
                    Liens hypertextes: Les sites internet de peuvent offrir des liens vers d’autres sites internet ou
                    d’autres ressources disponibles sur Internet. SAS EPIK ne dispose d’aucun moyen pour contrôler les
                    sites en connexion avec ses sites internet. ne répond pas de la disponibilité de tels sites et
                ...
                <p>
                    ...
                    hyperlien en direction de ce site sans l’autorisation expresse et préalable de SAS EPIK.
                </p>
                <p>
                    Dans l’hypothèse où un utilisateur ou visiteur souhaiterait mettre en place un hyperlien en
                    direction d’un des sites internet de SAS EPIK, il lui appartiendra d’adresser un email accessible
                    sur le site afin de formuler sa demande de mise en place d’un hyperlien. SAS EPIK se réserve le
                ...
                <p>
                    SAS EPIK s’efforce de fournir sur le site www.rezalps.fr des informations aussi précises que
                    possible. les renseignements figurant sur le site www.rezalps.fr ne sont pas exhaustifs et les
                    photos non contractuelles. Ils sont donnés sous réserve de modifications ayant été apportées depuis
                    leur mise en ligne. Par ailleurs, tous les informations indiquées sur le site www.rezalps.fr sont
                ...
                <p>
                    ...
                    vous constatez une lacune, erreur ou ce qui parait être un dysfonctionnement, merci de bien vouloir
                    le signaler par email, à l’adresse contact@epik.fr, en décrivant le problème de la manière la plus
                ...
                <p>
                    ...
                    ressources présentes sur le réseau Internet ne sauraient engager la responsabilité de SAS EPIK.
                </p>
                <h2>
                    Propriété intellectuelle:
                </h2>
                <p>
                    Tout le contenu du présent site www.rezalps.fr, incluant, de façon non limitative, les graphismes,
                ...
                <p>
                    ...
                    SAS EPIK. Cette représentation ou reproduction, par quelque procédé que ce soit, constitue une
                ...
                <p>
                    ...
                    visitez notre site Internet www.rezalps.fr.
                </p>
                <p>
