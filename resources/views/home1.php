    ...
    <div class="container-fluid" >
        ...
        <div class="row justify-content-center">
            ...
            <div class="col-lg-3 form-group">
                ...
                <form class="my_form" id="my_form1" method="post" action=""> <!-- method gère le mode d'envoi et action le fichier qui va gérer les données reçu. -->
                ...
                <form class="my_form" id="my_form2" method="post" action=""> <!-- method gère le mode d'envoi et action le fichier qui va gérer les données reçu. -->
                    <label for="entreprise"></label>
                    <input type="name" class="form-control" aria-describedby="écrire le nom de votre société" placeholder="Nom Entreprise" name="Entreprise" id="entreprise">
